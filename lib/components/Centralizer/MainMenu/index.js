...
var MainMenu = exports.MainMenu = function (_Component) {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						apps.map(function (app) {
							return _react2.default.createElement(
								'li',
								{ key: app.entityUUID, style: _styles2.default.li },
								_react2.default.createElement(
									'a',
									{ style: _styles2.default.link, href: app.appDomain },
									_react2.default.createElement('img', { style: _styles2.default.icon, src: app.appLogo }),
									app.appName
								)
							);
						})
